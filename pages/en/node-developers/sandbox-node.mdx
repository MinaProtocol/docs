...
- <DocLink copy="Install Mina" url="/using-mina/getting-started#installation" /> as usual and use many of the client commands. Since the daemon is already running in the container, you don't need to run `mina daemon`!
