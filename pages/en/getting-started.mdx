...
Follow along below to install the latest *Stable* Mina release or visit https://github.com/MinaProtocol/mina/releases to follow along and install pre-release builds.
