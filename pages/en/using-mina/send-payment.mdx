...
To generate a signed transaction using the Mina Signer, log the signed payment created as shown on the [Mina Signer README page](https://github.com/MinaProtocol/mina/blob/develop/frontend/mina-signer/README.md).
