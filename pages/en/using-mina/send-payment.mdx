...
### Using a keypair generated with the offline Mina Signer

To generate a signed transaction using Mina Signer, log the signed payment created as shown on the [Mina Signer README page](https://github.com/MinaProtocol/mina/blob/develop/frontend/mina-signer/README.md).
...
Transactions signed with Mina Signer can use: [https://minaexplorer.com/broadcast-tx](https://minaexplorer.com/broadcast-tx)
