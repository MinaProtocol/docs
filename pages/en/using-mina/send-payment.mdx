...
We are assuming in this section that you have the Mina client installed on your system, if you do not have Mina installed please see the <DocLink copy="Getting Started" url="/using-mina/getting-started" />.
