...
Follow along below to install the latest **Stable** [Mina Release 1.3.1](https://github.com/MinaProtocol/mina/releases/tag/1.3.1) or visit the [Github Releases Page](https://github.com/MinaProtocol/mina/releases) to discover and install pre-release (Beta) builds.
...
sudo apt-get update
sudo apt-get install -y curl unzip mina-mainnet=1.3.1-3e3abec
```
...
minaprotocol/mina-daemon:1.3.1-3e3abec-bullseye-mainnet \
daemon
```
