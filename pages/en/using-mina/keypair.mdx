...
Check that keygen tool installed correctly by running `mina-generate-keypair -version`. The output should read `Commit fe51f1ef5cfbcb4d5f559af39080963cf28ff1af on branch master `.
