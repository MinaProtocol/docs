...
sudo apt-get update
sudo apt-get install mina-generate-keypair=1.1.7-d5ff5aa
```

Check that keygen tool installed correctly by running `mina-generate-keypair -version`. The output should read `Commit d5ff5aa207e64bcd6862e1ae9a3b83910c1c7b1d on branch master `.
