...
sudo apt-get update
sudo apt-get install mina-generate-keypair=1.2.2-45440dc
```
...
```
cd ~
docker run  --interactive --tty --rm --volume $(pwd)/keys:/keys minaprotocol/mina-generate-keypair:1.2.2-45440dc --privkey-path /keys/my-wallet
```
