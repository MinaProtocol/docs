...
Note that you may want to generate more than one keypair. For example, if you'd like to run a block producer most securely, you'll want a [hot wallet / cold wallet block production setup](/docs/advanced/hot-cold-block-production).
...
See our [client SDK documentation](/docs/using-mina/keypair#client-sdk) for more information.
...
Now that we have created our keypair, we can finally [connect to the network](/docs/using-mina/connecting) or share your public key.
