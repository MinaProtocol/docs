...
Check that keygen tool installed correctly by running `mina-generate-keypair -version`. The output should read `Commit b10c0e3db9112a2a8aebc3eec7c6d2570fcc4044 on branch master `.
