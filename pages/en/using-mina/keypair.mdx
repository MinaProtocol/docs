...
We've also created an SDK called Mina Signer that is able to generate key pairs and sign transactions. Please note that this method is unadvised and should only be used by experienced security professionals. Please use our `mina-generate-keypair tool instead for creating key pairs.
See our <DocLink copy="Mina Signer documentation" url="/using-mina/keypair#mina-signer" /> for more information.
