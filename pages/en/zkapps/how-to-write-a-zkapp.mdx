...
The `index.ts` file is the entry point of your project. This file only imports all smart contract classes you want access to and exports them. This structure allows you to easily publish your smart contracts to npm.
