...
<figure>
  <img
    src="/static/img/docs-images/CLIs.png"
    alt="Terminal screenshot of Mina’s snapps from a command-line interface."
    width="50%"
  />
  <figcaption>
...
<figure>
  <img
    src="/static/img/docs-images/1_Snapps_Off-Chain_Performance.jpg"
    alt="How zkApps work"
    width="90%"
  />
  <figcaption>
    Snapps can perform arbitrarily complex computations off chain while
...
<figure>
  <img
    ...
    alt="Examples of applications that could use snapps."
    width="85%"
  />
  <figcaption>
    Snapps are a great fit for applications that require proof that you have a
