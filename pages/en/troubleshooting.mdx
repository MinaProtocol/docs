...
- Run as a systemd service (see [the docs](/docs/using-mina/connecting#ubuntu-1804--debian-9-1)).
- Run with Docker (see [the docs](/docs/using-mina/connecting#docker)).
...
See the requirements for the current network [here](https://minaprotocol.com/docs/getting-started). Some lower-tier VPS providers may have an issue producing blocks within the slot time. If you continue to experience missing blocks, you may wish to try on more powerful hardware.
