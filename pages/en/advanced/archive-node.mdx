...
1. Install the latest version of mina. If you haven't upgraded to the latest version of the daemon, head <DocLink copy="back to the docs" url="/getting-started" /> to get the latest version. You can run `mina -help` to check if the installation succeeded.
...
3. Install the archive node package.
   ...
   - Ubuntu/Debian:
     ...
     ```
     sudo apt-get install mina-archive=1.3.0-c278209
     ```

   - Docker:
     ```
     minaprotocol/mina-archive:1.3.0-c278209-bullseye
     ```
