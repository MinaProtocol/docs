...
```
sha256sum ledger-app-mina-1.0.1-beta.1-0-g843e809c.tar.gz
```
...
```
$ tar xvzf ledger-app-mina-1.0.1-beta.1-0-g843e809c.tar.gz
ledger-app-mina-1.0.1-beta.1-0-g843e809c/README
ledger-app-mina-1.0.1-beta.1-0-g843e809c/install.sh
ledger-app-mina-1.0.1-beta.1-0-g843e809c/uninstall.sh
ledger-app-mina-1.0.1-beta.1-0-g843e809c/mina_ledger_wallet
ledger-app-mina-1.0.1-beta.1-0-g843e809c/bin/app.hex
```
...
```
$ cd ledger-app-mina-1.0.1-beta.1-0-g843e809c
$ ./install.sh
...
```
shasum -a 256 ledger-app-mina-1.0.1-beta.1-0-g843e809c.tar.gz
```
...
Download the [Latest Ledger App Mina Release](https://github.com/jspada/ledger-app-mina/releases/download/v1.0.0-beta.4/ledger-app-mina-1.0.1-beta.1-0-g843e809c.zip) from Github.
...
```
Get-FileHash -Path ledger-app-mina-1.0.1-beta.1-0-g843e809c.zip
```
...
```
PS > cd ledger-app-mina-1.0.1-beta.1-0-g843e809c
```
...
```
PS ...\ledger-app-mina-1.0.1-beta.1-0-g843e809c> python3 -m ledgerblue.deleteApp "--targetId" "0x31100004" "--appName" "Mina"
```
...
```
PS ...\ledger-app-mina-1.0.1-beta.1-0-g843e809c> python3 -m ledgerblue.loadApp "--path" "44'/12586'" "--appFlags" "0x240" "--tlv" "--targetId" "0x31100004" "--targetVersion=1.6.0" "--delete" "--fileName" "bin/app.hex" "--appName" "Mina" "--appVersion" "1.0.0" "--dataSize" "64" "--icon" "010000000000ffffffffffffffffffeff7c7e393c9b3cdb3cdb3cdb3cdb3cd33cc799effffffffffff"
