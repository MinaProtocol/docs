...
Check that keygen tool installed correctly by running `mina-generate-keypair -version`. The output should read `Commit 06f3c5cdeb635b2564fcb2edac4f10db85b93c36 on branch master`.
