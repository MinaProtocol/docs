...
In addition to [installing the Mina daemon on your machine](/docs/getting-started), you may also want to have some system set up to archive historical information on your machine. To do so you can setup an [archive node](/docs/advanced/archive-node) and/or archive via [other redundant means](/docs/advanced/archive-redundancy).

## Running a node

The best way to learn how to run a node is to follow the instructions on the [Connecting page](/docs/using-mina/connecting) of the docs.
