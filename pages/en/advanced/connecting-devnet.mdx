...
Follow along below to install the latest **Stable** [Mina Release 1.2.1](https://github.com/MinaProtocol/mina/releases/tag/1.2.1) or visit the [Github Releases Page](https://github.com/MinaProtocol/mina/releases) to discover and install pre-release (Alpha/Beta) builds.
...
sudo apt-get update
sudo apt-get install -y curl unzip mina-devnet=1.2.1-45440dc
```

Check that daemon installed correctly by running `mina version`. The output should read `Commit 45440dc7e4c5dac480dd075357c1d369b893fbe1 on branch master`.
...
minaprotocol/mina-daemon:1.2.1-45440dc-mainnet \
daemon \
