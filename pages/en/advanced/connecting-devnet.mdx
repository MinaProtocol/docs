...
sudo apt-get update
sudo apt-get install -y curl unzip mina-devnet=1.2.0-fe51f1e
```

Check that daemon installed correctly by running `mina version`. The output should read `Commit fe51f1ef5cfbcb4d5f559af39080963cf28ff1af on branch master`.
