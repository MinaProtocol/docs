...
- [Latest Release Notes for Mina Protocol](https://github.com/MinaProtocol/mina/releases/tag/].3.0)
...
- <DocLink copy="Mina Docs: Foundation Delegation Program" url="/advanced/delegation"/>
