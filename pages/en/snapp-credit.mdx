...
This will submit the SNARK proof to the Mina Snappnet chain and Teller will await it's confirmation. This process of verifying a SNARK proof on the chain takes 3-15 min so please be patient as you wait for confirmation
