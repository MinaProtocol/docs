...
When participating in the Foundation Delegation Program you will also need to run the uptime sidecar, so please following [these instructions](/docs/node-operators/bp-sidecar) and set it up alongside your block producer daemon.
