...
Now that you've installed Mina and configured your network, let's move on to the next step - <DocLink copy="generating a keypair!" url="/node-operators/keypair" />
