...
denominated in the MINA token. Using a zkApp, custom tokens can be
minted, creating accounts denominated in those tokens. Every custom token
has a token owner, and, after their minting, any transfer of custom tokens
