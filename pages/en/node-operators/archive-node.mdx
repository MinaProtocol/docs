...
1. Install the latest version of mina. If you haven't upgraded to the latest version of the daemon, head <DocLink copy="back to the docs" url="/using-mina/getting-started" /> to get the latest version. You can run `mina -help` to check if the installation succeeded.
