...
Head over to the <DocLink copy="Docker" url="/using-mina/connecting#docker" /> <DocLink copy="Devnet page" url="/node-operators/connecting-devnet" /> to learn more and get started.
...
<DocLink copy="See here" url="/using-mina/connecting#ubuntu-1804--debian-9-1" /> for
