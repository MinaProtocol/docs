...
zkApps are written in TypeScript using the Mina zkApp CLI. In the upcoming section <DocLink copy="How to write a zkApp" url="/snapps/how-to-write-a-zkApp" />, we’ll go into detail about writing your first zkApp. For now, we’ll discuss how zkApps work.
...
<img src="/static/img/docs-images/7_zkapps_DeploysnappUI.jpg" width="95%" />
<br></br>
