...
Snapps are written in TypeScript using the Mina zkApp CLI. In the upcoming section, <DocLink copy="how to write a zkApp" url="/snapps/how-to-write-a-zkApp" />, we’ll go into detail about writing your first zkApp. For now, we’ll discuss how zkapps work.
...
Your website needs to contain the `smart_contract.js` file that was generated when building your smart contract. On the <DocLink copy="how to write a zkApp" url="/snapps/how-to-write-a-zkApp" /> page, we will go into more detail.
...
After a zkApp is deployed to a host (e.g.  mycoolsnapp.com), users can interact with it:
...
On the next page, we’ll dive into <DocLink copy="how to write a zkApp" url="/snapps/how-to-write-a-zkApp" />!