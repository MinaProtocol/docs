...
Snapps are written in TypeScript using the Snapp CLI. In the upcoming section, <DocLink copy="How to write a snapp (coming soon)" url="/snarky" />, we’ll go into detail about writing your first snapp. For now, we’ll discuss how snapps work.
