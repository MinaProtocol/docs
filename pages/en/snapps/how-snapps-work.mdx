...
Snapps are written in TypeScript using the Snapp CLI. In the upcoming section, <DocLink copy="how to write a snapp" url="/snapps/how-to-write-a-snapp" />, we’ll go into detail about writing your first snapp. For now, we’ll discuss how snapps work.
...
Your website needs to contain the `smart_contract.js` file that was generated when building your smart contract. On the <DocLink copy="how to write a snapp" url="/snapps/how-to-write-a-snapp" /> page, we will go into more detail.
...
On the next page, we’ll dive into <DocLink copy="how to write a snapp" url="/snapps/how-to-write-a-snapp" />!