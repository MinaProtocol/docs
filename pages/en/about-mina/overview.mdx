...
Learn more about Mina’s unique protocol architecture <DocLink copy="here" url="/about-mina/protocol-architecture" />.

### What are zero-knowledge proofs?

Mina’s unique characteristics are made possible using  zero-knowledge proofs.

Watch this video to learn about zero-knowledge proofs <DocLink copy="here" url="/about-mina/what-are-zero-knowledge-proofs" />.
...
Learn more about how zkApps work <DocLink copy="here" url="/zkapps/" />.
...
Read more about Mina’s consensus mechanism <DocLink copy="here" url="/about-mina/consensus" />.
