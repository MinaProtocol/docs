...
The current snark pool is visible via <DocLink copy="GraphQL" url="/node-developers/graphql-api" /> or the CLI via the `mina advanced snark-pool` command.
