...
Bu paket SNARKların içerisinde kullanım için uygun olan alan aritmetiği, hash fonsiyonu, Merkle ağacı modülü, ve Schnorr imzaları sağlamaktadır. Buradan indirebilirsiniz

```
npm install snarkyjs-crypto
```

API kullanımı için lütfen buradaki örneğe bakın [bakın.](https://github.com/o1-labs/snarkyjs-crypto/blob/master/example.js)
