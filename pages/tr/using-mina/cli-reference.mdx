...
Mina CLI (komut satýrý arayüzü)kullanýcýlarýn Mina aðýyla etkileþim kurmasýnýn birincil yoludur. Hesaplar oluþturmak, iþlemler göndermek ve konsensüsa katýlmak için standart müþteri iþlevselliði saðlar. Ýleri düzey kullanýcýlar için geliþmiþ istemci ve daemon komutlarý da vardýr.

<DocLink copy="Mina'yý kurduðunuzda" url="/getting-started#installation" />
CLI kurulur.

<Alert kind="warning">

Mina API (Uygulama Programlarý Arayüzü)'larý hala yapým aþamasýndadýr, bu nedenle bu komutlar büyük olasýlýkla deðiþecektir. En güncel sürüm için`mina desteðe` bakýn.
