...
You'll notice that this command looks suspiciously like a <DocLink copy="payment" url="/my-first-transaction#make-a-payment" /> transaction. That's because a stake delegation is also a transaction! This is why we have to pay a small transaction fee in order to change this setting.
