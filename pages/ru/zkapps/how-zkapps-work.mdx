...
zkApps are written in TypeScript using the Snapp CLI. In the upcoming section, How to write a snapp (_coming soon_), we’ll go into detail about writing your first snapp. For now, we’ll discuss how zkApps work.
