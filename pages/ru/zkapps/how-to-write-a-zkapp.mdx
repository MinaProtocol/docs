...
The <a href="https://jestjs.io/">Jest testing framework</a> is included in all projects created by the zkApp CLI via `zkApp project <name>`. We recommend Jest, but any testing framework can be used.
