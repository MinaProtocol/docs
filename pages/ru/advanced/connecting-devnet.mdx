...
Убедитесь, что daemon установлен правильно, запустив `mina version`. На выходе должно появиться сообщение `Commit 5b35b27df8e137ddbe88874b4efdcf4bb2cb4ae9 on branch master`.
