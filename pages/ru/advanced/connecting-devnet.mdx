...
sudo apt-get update
sudo apt-get install -y curl unzip mina-devnet=1.2.2-45440dc
```

Убедитесь, что daemon установлен правильно, запустив `mina version`. На выходе должно появиться сообщение `Commit 45440dc7e4c5dac480dd075357c1d369b893fbe1 on branch master`.
