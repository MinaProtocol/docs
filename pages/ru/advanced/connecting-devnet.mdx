...
Убедитесь, что daemon установлен правильно, запустив `mina version`. На выходе должно появиться сообщение `Commit fe51f1ef5cfbcb4d5f559af39080963cf28ff1af on branch master`.
