...
Убедитесь, что daemon установлен правильно, запустив `mina version`. На выходе должно появиться сообщение `Commit c27820915d358366f027f025030e2d2d158c4d53 on branch master`.
