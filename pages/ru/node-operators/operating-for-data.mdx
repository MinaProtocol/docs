...
В дополнение к <DocLink copy="установке Mina daemon на ваш компьютер" url="/node-operators/getting-started" />, вам также может понадобиться настроить систему для архивирования данных на вашем компьютере. Для этого вы можете настроить <DocLink copy="архивную ноду" url="/node-operators/archive-node" /> и/или архивировать данные, используя <DocLink copy="другие способы" url="/node-operators/archive-redundancy" />.
