...
This functionality is currently under development in a Pre-release for testing.
...
```
$ tar xvzf mina-ledger-app-1.0.0-beta.2-0-XXX.tar.gz
mina-ledger-app-1.0.0-beta.2-0-XXX/README
mina-ledger-app-1.0.0-beta.2-0-XXX/install.sh
mina-ledger-app-1.0.0-beta.2-0-XXX/uninstall.sh
mina-ledger-app-1.0.0-beta.2-0-XXX/mina_ledger_wallet
mina-ledger-app-1.0.0-beta.2-0-XXX/bin/app.hex
```
### 6) Launch the installation script

```
$ cd mina-ledger-app-1.0.0-beta.2-0-XXX
$ ./install.sh
