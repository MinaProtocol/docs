...
Download the [Latest Ledger App Mina Release](https://github.com/jspada/ledger-app-mina/releases/download/v1.0.0-beta.3/ledger-app-mina-1.0.0-beta.3-0-g0680a71c.zip) from Github.
...
### 6) Change directory to the newly extracted archive

```
PS > cd ledger-app-mina-1.0.0-beta.3-0-g0680a71c
```

### 7) (Optional) Uninstall a previous version of the mina app

If you have installed the mina app before, begin by uninstalling the old version with the following command:
```
PS ...\ledger-app-mina-1.0.0-beta.3-0-g0680a71c> python3 -m ledgerblue.deleteApp "--targetId" "0x31100004" "--appName" "Mina"
```
Make sure to approve any prompts on the ledger device itself.


### 8) Start the Installation of the new release

```
PS ...\ledger-app-mina-1.0.0-beta.3-0-g0680a71c> python3 -m ledgerblue.loadApp "--path" "44'/12586'" "--appFlags" "0x240" "--tlv" "--targetId" "0x31100004" "--targetVersion=1.6.0" "--delete" "--fileName" "bin/app.hex" "--appName" "Mina" "--appVersion" "1.0.0" "--dataSize" "64" "--icon" "010000000000ffffffffffffffffffeff7c7e393c9b3cdb3cdb3cdb3cdb3cd33cc799effffffffffff"
