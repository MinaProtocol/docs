...
```
./utils/mina_ledger_wallet.py test-transaction 0 B62qnzbXmRNo9q32n4SNu2mpB8e7FYYLH8NmaX6oFCBYjjQ8SbD7uzV | coda advanced validate-transaction
```

Replace `B62q...` with your public key.
