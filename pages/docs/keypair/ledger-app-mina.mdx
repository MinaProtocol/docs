...
We are working on support for [Ledger Nano X](https://www.ledger.com/), but need to wait until we are included in Ledger Live.
...
```
$ tar xvzf ledger-app-mina-1.0.0-beta.2-0-g70a46fd7.tar.gz
ledger-app-mina-1.0.0-beta.2-0-g70a46fd7/README
ledger-app-mina-1.0.0-beta.2-0-g70a46fd7/install.sh
ledger-app-mina-1.0.0-beta.2-0-g70a46fd7/uninstall.sh
ledger-app-mina-1.0.0-beta.2-0-g70a46fd7/mina_ledger_wallet
ledger-app-mina-1.0.0-beta.2-0-g70a46fd7/bin/app.hex
```
### 7) Launch the installation script

```
$ cd ledger-app-mina-1.0.0-beta.2-0-g70a46fd7
$ ./install.sh
...
```
./utils/mina_ledger_wallet.py test-transaction 42 B62qnzbXmRNo9q32n4SNu2mpB8e7FYYLH8NmaX6oFCBYjjQ8SbD7uzV | coda advanced validate-transaction
```

Replace "B62q... " with your public key and 42 with your BIP44 account number.
