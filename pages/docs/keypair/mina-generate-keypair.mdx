...
3a. Now we can generate our keys using the `mina-generate-keypair` command. You will be prompted to provide a password for the new keypair. <em>Do NOT forget this password.</em>

```
mina-generate-keypair -privkey-path ~/keys/my-wallet
```

3b. OR in Docker on any machine that supports it (including Windows and MacOS)
