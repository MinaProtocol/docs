...
Now that you've created your key -- you'll want to validate that it works. It's sufficient to verify the following: That you can sign a transaction, and that you can stake with your private key (ie. a VRF can be evaluated). You can verify both of these things using the `mina-validate-keypair` tool.

Run the following command:

(TODO: @psteckler to provide more details)
