...
sudo apt-get update
sudo apt-get install -y curl unzip mina-mainnet=1.1.1-7e959a7
```

Check that daemon installed correctly by running `mina version`. The output should read `Commit 7e959a7683442f0e3e17dbc0bd3d776f617425ef on branch master`.
