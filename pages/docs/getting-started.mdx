...
Welcome to Mina! This section will walk you through the process of setting up a Mina node. After we will show you how to generate a keypair for submission prior to a new Testnet. Finally we'll show you how to connect to the network and begin producing blocks.
...
Check that daemon installed correctly by running `mina version`. The output should read `Commit 48401e92d94948c066c03ca76326c065e5cbfc92 on branch master`.
