...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]b14e32415b15af04865ca069af31cea7716be251 on branch HEAD`.

Note that the docker version below is different at the moment and will read `[DIRTY]9614ad972009c572a1bdcec402d58d83f23253aa`
