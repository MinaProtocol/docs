...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]5493fe344b40b6e668315fb8db4aa7eef4f1963f on branch HEAD`.

## Setup Keypair

For Encore, we are using the same ledger from Testworld, with pre-generated keypairs that you should have recieved via email in December. If you did not recieve a key via email, you can also generate one.
...
minaprotocol/mina-daemon-baked:0.3.0-5493fe3-encore-7b5c386 \
daemon \
