...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]62e11d5c7de45ffdb0dcd50b389c8218f052c016 on branch HEAD`.
...
minaprotocol/mina-daemon-baked:0.2.10-62e11d5-testworld-62e11d5 \
daemon \
