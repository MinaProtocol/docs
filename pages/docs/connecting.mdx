...
```
brew upgrade mina
cp /tmp/s3_cache_dir/config_f5aa1fb.json ~/.coda_config/daemon.json
```

Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]f5aa1fb1b6fa4e0fabbc8f7221c0ca94d31fa0c9 on branch HEAD`.
...
minaprotocol/mina-daemon-baked:4.1-turbo-pickles-minaf5aa1fb-autoa7dc7bb \
daemon \
