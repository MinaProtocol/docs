...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]41db20648b566908881a17c8b0248d05f517f25a on branch HEAD`.
