...
Due to the limited number of spots available, you'll first need to get the most recent peer list. The inital participants have already been selected, but you can sign up for the waitlist [here](http://bit.ly/StakingSignup) in case a spot opens up.

Once you're in, you'll receive an email with the latest peer list and updated commands.
