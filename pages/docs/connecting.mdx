...
sudo apt-get update
sudo apt-get install -y curl unzip mina-testnet-postake-medium-curves=0.2.3-b2345c0 --allow-downgrades
```

Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]b2345c02d2842dcab2603aeb2b220b32d5f66cd3 on branch HEAD`.
...
minaprotocol/mina-daemon-baked:0.2.3-b2345c0-testworld-b2345c0 \
daemon \
