...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]56b97f1b73165b089725b85eef65c859460be2ea on branch HEAD`.
...
Now that the network has been stable for a while, we are inviting anyone who is interested to download the peers list and connect to Testnet 4.1.
```
...
minaprotocol/mina-daemon-baked:4.1-turbo-pickles-mina78ff1c7-autoe7f1072 \
daemon \
