...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]d44a1339bdbdd5ebe747124c7146f435a3f73453 on branch HEAD`.
...
minaprotocol/mina-daemon-baked:0.2.5-d44a133-testworld-d44a133 \
daemon \
