...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]d075f83d26490f6510bbb14bbfe3c771256257b5 on branch HEAD`.
