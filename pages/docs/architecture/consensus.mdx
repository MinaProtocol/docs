...
!!! note
This document only covers the generalized consensus mechanism abstraction in Mina. For information on the implementation of Proof of Stake in Mina, [see the relevant documentation](/docs/architecture/proof-of-stake).
