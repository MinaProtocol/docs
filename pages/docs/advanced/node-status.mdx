...
This sidecar will need to communicate with a running daemon, so you will first need to start your daemon. Instructions can be found on the [connecting page](/docs/connecting).
...
Then to manually start the service, use this command:
