...
```
sha256sum ledger-app-mina-1.0.0-beta.4-0-g5421f6f4.tar.gz
```
...
```
$ tar xvzf ledger-app-mina-1.0.0-beta.4-0-g5421f6f4.tar.gz
ledger-app-mina-1.0.0-beta.4-0-g5421f6f4/README
ledger-app-mina-1.0.0-beta.4-0-g5421f6f4/install.sh
ledger-app-mina-1.0.0-beta.4-0-g5421f6f4/uninstall.sh
ledger-app-mina-1.0.0-beta.4-0-g5421f6f4/mina_ledger_wallet
ledger-app-mina-1.0.0-beta.4-0-g5421f6f4/bin/app.hex
```
...
```
$ cd ledger-app-mina-1.0.0-beta.4-0-g5421f6f4
$ ./install.sh
...
```
shasum -a 256 ledger-app-mina-1.0.0-beta.4-0-g5421f6f4.tar.gz
```
...
Download the [Latest Ledger App Mina Release](https://github.com/jspada/ledger-app-mina/releases/download/v1.0.0-beta.4/ledger-app-mina-1.0.0-beta.4-0-g5421f6f4.zip) from Github.

### 5) Verify the checksum

In the powershell terminal, run the following command:
```
Get-FileHash -Path ledger-app-mina-1.0.0-beta.4-0-g5421f6f4.zip
```
...
```
PS > cd ledger-app-mina-1.0.0-beta.4-0-g5421f6f4
```
...
```
PS ...\ledger-app-mina-1.0.0-beta.4-0-g5421f6f4> python3 -m ledgerblue.deleteApp "--targetId" "0x31100004" "--appName" "Mina"
```
...
```
PS ...\ledger-app-mina-1.0.0-beta.4-0-g5421f6f4> python3 -m ledgerblue.loadApp "--path" "44'/12586'" "--appFlags" "0x240" "--tlv" "--targetId" "0x31100004" "--targetVersion=1.6.0" "--delete" "--fileName" "bin/app.hex" "--appName" "Mina" "--appVersion" "1.0.0" "--dataSize" "64" "--icon" "010000000000ffffffffffffffffffeff7c7e393c9b3cdb3cdb3cdb3cdb3cd33cc799effffffffffff"
...
### 12) Install the command-line wallet
...
The parts of validation here that are embedded into the Mina client will ship officially early next week. If you're so inclined, you can build from source yourself on the `compatible` branch and you'll find the functionality you need.
