...
The output will be a JSON blob that you will need for the next section.
...
3. Paste the output from the `mina_ledger_wallet` in the previous section.

This will send the signed transaction on the network.
