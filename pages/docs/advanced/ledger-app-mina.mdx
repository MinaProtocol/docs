...
In order to validate your private key. make sure you have updated to the latest version of the `mina` damemon. Instructions can be found on the [connecting](/docs/connecting) page.
