...
Check that daemon installed correctly by running `coda version`. The output should read `Commit [DIRTY]68200c7b409e105d174f079c5c39f7926819784b on branch HEAD`.
