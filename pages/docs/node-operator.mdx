...
By creating a file at `~/.coda-config/daemon.json`, you can configure your coda daemon without needing to provide options on the commandline. This can be useful for running mina as a service as well as just for avoiding repetitive typing!
