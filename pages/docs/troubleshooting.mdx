...
Not all waitlist participants have a balance, and if you are one of them, you can still sync a node and request funds from the faucet or other community members. Your node will need to be synced before any balance from the faucet or community members will be visible via `mina accounts list`. There may be additional stake redistributions at a later time, assuming you have a synced node.
