...
Mina is entirely open source, and the code is distributed under the terms of the Apache License 2.0. To contribute code to the Mina protocol, check us out on [Github](https://github.com/MinaProtocol).
