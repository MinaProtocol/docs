...
let make = () => {
  <Page title="Demo page of components">
    ...
    <div className=Styles.page>
      ...
      <div className=Theme.Type.announcement> <AnnouncementBar /> </div>
      <div className=Theme.Type.reward> <RewardsPromo /> </div>
      <div className=Theme.Type.testworld>
              ...
              <TestworldChallenges.Accordian>
                ...
                <TestworldChallenges.List
                  ...
                  rules=[|
                    ...
                    "Testworld's top 20 block producing nodes will receive equal delegation.",
                    "Each node will be delegated 5% of Foundation tokens.",
                    "Selection criteria will be based on a combination of uptime & blocks produced.",
                  |]
                />
                <TestworldChallenges.List
