module Styles = {
      ...
      style([
        ...
        selector(
          ...
          [
            ...
            media(Theme.MediaQuery.mobile, [fontSize(`px(40))]),
          ],
        ),
        media(Theme.MediaQuery.mobile, [flexDirection(`column)]),
      ]),
    ]);
  ...
  let background =
    style([
      ...
      media(Theme.MediaQuery.mobile, [height(`px(794))]),
    ]);
  ...
  let column =
    style([
      ...
      flex(`num(1.)),
      color(Css_Colors.white),
      media(Theme.MediaQuery.mobile, [padding(`px(15))]),
    ]);
};
